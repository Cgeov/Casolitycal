...
namespace Proyecto
{
    public partial class Administrador : Form
    {
        ...
        Queue<Departamento> Depa = new Queue<Departamento>();
        Queue<Usuarios> Empleados = new Queue<Usuarios>();
        ...
        private void btnAñadirUsuario_Click(object sender, EventArgs e)
        {
            ...
            if (state)
            {
                Usuarios depart = new Usuarios();
                depart.Rol = cmboRol.SelectedValue.ToString();
                depart.Departamento = cmboDepa.SelectedValue.ToString();
                depart.Nombre = txtNombreUsuario.Text;
                depart.Usuario = txtUsername.Text;
                depart.Contraseña = txtContraseña.Text;
                Empleados.Enqueue(depart);
        ...
        private void btnAgregarDepartamento_Click(object sender, EventArgs e)
        {
            ...
            if (state)
            {
                ...
                depart.nombre = txtNombreDepartamento.Text;
                Depa.Enqueue(depart);
                consultas.insertarDepartamento(Depa);
